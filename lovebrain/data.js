...
const questions = [
    ...
    { id: 5, text: "我会把对方的小优点放大，觉得那是他'与众不同'的证据", dimension: "idealization", reverse: false },
    
    // 维度2: 依恋焦虑 (Attachment Anxiety) - 5题
    ...
    // 维度3: 边界模糊 (Boundary Diffusion) - 5题
    ...
    { id: 15, text: "我很难对伴侣说'不'，即使心里不愿意", dimension: "boundary", reverse: false },
    
    // 维度4: 过度付出 (Over-giving) - 5题
    { id: 16, text: "我愿意为对方付出一切，即使对方没要求", dimension: "overgiving", reverse: false },
    { id: 17, text: "我觉得'爱一个人就要无条件付出'", dimension: "overgiving", reverse: false },
    ...
    // 维度5: 分离焦虑 (Separation Anxiety) - 5题
    ...
    // 维度6: 纠缠执念 (Rumination & Obsession) - 5题
    ...
    { id: 28, text: "分手后，我有过'报复'对方的想法", dimension: "rumination", reverse: false },
    { id: 29, text: "我很难接受'不爱了'这个事实，总觉得还有机会", dimension: "rumination", reverse: false },
...
const dimensions = {
    idealization: {
        name: "认知偏差：理想化倾向",
        nameShort: "理想化倾向",
        psychology: "理想化倾向在恋爱初期是正常现象，心理学称为'积极错觉'，适度的美化有助于关系满意度。但过度理想化会让人忽视危险信号，陷入不健康关系而不自知。",
    ...
    boundary: {
        name: "自我分化：边界清晰度",
        nameShort: "边界清晰度",
        psychology: "Bowen的自我分化理论指出，低分化的人在关系中容易'融合'，分不清自己的感受和对方的感受，倾向于为对方的情绪负责。",
        lowDesc: "你能在关系中保持清晰的自我边界。",
        highDesc: "你容易在关系中失去自我边界，习惯性为对方妥协。",
        lowAdvice: "你的边界感很好，这是健康关系的基础。",
        highAdvice: "练习说'不'，从小事开始；写下'我的底线是什么'并温和地维护它。"
    },
    overgiving: {
        name: "关系模式：过度付出倾向",
        nameShort: "过度付出",
    ...
    separation: {
        ...
        lowAdvice: "你的独处能力很好。",
        highAdvice: "练习独处：每周安排2小时完全独处；写下'单身的好处'清单。"
    },
    rumination: {
        name: "执念水平：反刍与未完成情结",
        nameShort: "执念水平",
        psychology: "反刍思维指反复沉浸于负面情绪和事件的思维模式。Zeigarnik效应指出，人们对'未完成'的事记忆更深，分手作为'未完成的关系'更难放下。",
        lowDesc: "你能较好地放下过去，向前看。",
        highDesc: "你容易陷入对过去关系的反复回想和执念。",
        lowAdvice: "你的放下能力很好。",
        highAdvice: "给自己设一个'允许难过'的期限；把想说的话写下来但不发送；寻求朋友或专业人士的支持。"
    }
};
...
const resultTypes = [
    ...
    { min: 51, max: 75, type: "情境依赖型", tag: "轻度倾向", desc: "你大部分时间清醒，但遇到特定情境或心动的人时容易'上头'。" },
